...
* Create an [issue](https://github.com/jonnitto/Jonnitto.Image/issues) on GitHub, if you have found a bug
...
* Submit an [issue](https://github.com/jonnitto/Jonnitto.Image/issues), assuming one does not already exist.
